...
public final class BlockTags {
   ...
   public static final ITag.INamedTag<Block> BUSHES = makeWrapperTag("bushes");
   public static final ITag.INamedTag<Block> POLLINATABLE = makeWrapperTag("bee_pollinatable");
